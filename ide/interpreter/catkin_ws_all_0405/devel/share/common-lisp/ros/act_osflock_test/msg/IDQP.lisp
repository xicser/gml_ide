...
(cl:in-package act_osflock_test-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <IDQP>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IDQP)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name act_osflock_test-msg:<IDQP> is deprecated: use act_osflock_test-msg:IDQP instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <IDQP>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader act_osflock_test-msg:id-val is deprecated.  Use act_osflock_test-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'q-val :lambda-list '(m))
(cl:defmethod q-val ((m <IDQP>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader act_osflock_test-msg:q-val is deprecated.  Use act_osflock_test-msg:q instead.")
  (q m))

(cl:ensure-generic-function 'p-val :lambda-list '(m))
(cl:defmethod p-val ((m <IDQP>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader act_osflock_test-msg:p-val is deprecated.  Use act_osflock_test-msg:p instead.")
  (p m))
