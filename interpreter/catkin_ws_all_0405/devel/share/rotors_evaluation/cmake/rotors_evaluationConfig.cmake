...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /home/cps/catkin_ws_all_0405/src/rotors_simulator/rotors_evaluation)
  set(rotors_evaluation_DEVEL_PREFIX /home/cps/catkin_ws_all_0405/devel)
  ...
  set(rotors_evaluation_INSTALL_PREFIX /home/cps/catkin_ws_all_0405/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cps/catkin_ws_all_0405/src/rotors_simulator/rotors_evaluation/${idir}'.  ${_report}")
    endif()
