...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WaypointList>)))
  ...
  (cl:format cl:nil "Waypoint[] waypoint_list~%~%================================================================================~%MSG: dji_sdk/Waypoint~%float64 latitude      # in degree~%float64 longitude     # in degree~%float32 altitude~%int16 heading         #heading is in [-180,180]~%uint16 staytime       # in second~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WaypointList)))
  "Returns full string definition for message of type 'WaypointList"
  (cl:format cl:nil "Waypoint[] waypoint_list~%~%================================================================================~%MSG: dji_sdk/Waypoint~%float64 latitude      # in degree~%float64 longitude     # in degree~%float32 altitude~%int16 heading         #heading is in [-180,180]~%uint16 staytime       # in second~%~%~%~%"))
