...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionHotpointTask>)))
  ...
  (cl:format cl:nil "float64 latitude  # degree~%float64 longitude # degree~%float64 altitude  # meter~%float64 radius    # meter~%float32 angular_speed #deg/s~%uint8 is_clockwise~%uint8 start_point~%uint8 yaw_mode~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionHotpointTask)))
  "Returns full string definition for message of type 'MissionHotpointTask"
  (cl:format cl:nil "float64 latitude  # degree~%float64 longitude # degree~%float64 altitude  # meter~%float64 radius    # meter~%float32 angular_speed #deg/s~%uint8 is_clockwise~%uint8 start_point~%uint8 yaw_mode~%~%~%"))
