...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Octomap-request>)))
  ...
  (cl:format cl:nil "~%geometry_msgs/Point bounding_box_origin~%~%geometry_msgs/Point bounding_box_lengths~%~%float64 leaf_size~%~%bool publish_octomap~%~%string filename~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Octomap-request)))
  "Returns full string definition for message of type 'Octomap-request"
  (cl:format cl:nil "~%geometry_msgs/Point bounding_box_origin~%~%geometry_msgs/Point bounding_box_lengths~%~%float64 leaf_size~%~%bool publish_octomap~%~%string filename~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
