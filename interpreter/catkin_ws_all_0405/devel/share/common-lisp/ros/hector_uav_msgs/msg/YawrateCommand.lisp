...
(cl:defmethod cl:initialize-instance :after ((m <YawrateCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'YawrateCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<YawrateCommand> is deprecated: use hector_uav_msgs-msg:YawrateCommand instead.")))
...
(cl:defmethod turnrate-val ((m <YawrateCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:turnrate-val is deprecated.  Use hector_uav_msgs-msg:turnrate instead.")
  (turnrate m))
