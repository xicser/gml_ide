...
(cl:defmethod cl:initialize-instance :after ((m <RawMagnetic>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RawMagnetic)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<RawMagnetic> is deprecated: use hector_uav_msgs-msg:RawMagnetic instead.")))
