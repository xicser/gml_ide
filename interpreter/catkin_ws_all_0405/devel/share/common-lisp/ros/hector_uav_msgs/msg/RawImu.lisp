...
(cl:defmethod cl:initialize-instance :after ((m <RawImu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RawImu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<RawImu> is deprecated: use hector_uav_msgs-msg:RawImu instead.")))
...
(cl:defmethod angular_velocity-val ((m <RawImu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:angular_velocity-val is deprecated.  Use hector_uav_msgs-msg:angular_velocity instead.")
  (angular_velocity m))

(cl:ensure-generic-function 'linear_acceleration-val :lambda-list '(m))
(cl:defmethod linear_acceleration-val ((m <RawImu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:linear_acceleration-val is deprecated.  Use hector_uav_msgs-msg:linear_acceleration instead.")
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RawImu>)))
  ...
  "398f651a68070a719c7938171d0fcc45")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RawImu)))
  "Returns md5sum for a message object of type 'RawImu"
  "398f651a68070a719c7938171d0fcc45")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RawImu>)))
  ...
  (cl:format cl:nil "Header header~%int16[3] angular_velocity~%int16[3] linear_acceleration~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RawImu)))
  "Returns full string definition for message of type 'RawImu"
  (cl:format cl:nil "Header header~%int16[3] angular_velocity~%int16[3] linear_acceleration~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
