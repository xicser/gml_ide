...
(cl:defmethod cl:initialize-instance :after ((m <Compass>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Compass)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<Compass> is deprecated: use hector_uav_msgs-msg:Compass instead.")))
...
(cl:defmethod magnetic_heading-val ((m <Compass>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:magnetic_heading-val is deprecated.  Use hector_uav_msgs-msg:magnetic_heading instead.")
  (magnetic_heading m))

(cl:ensure-generic-function 'declination-val :lambda-list '(m))
(cl:defmethod declination-val ((m <Compass>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:declination-val is deprecated.  Use hector_uav_msgs-msg:declination instead.")
  (declination m))
