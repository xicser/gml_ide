...
(cl:defmethod cl:initialize-instance :after ((m <RawRC>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RawRC)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<RawRC> is deprecated: use hector_uav_msgs-msg:RawRC instead.")))
...
(cl:defmethod channel-val ((m <RawRC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:channel-val is deprecated.  Use hector_uav_msgs-msg:channel instead.")
  (channel m))
