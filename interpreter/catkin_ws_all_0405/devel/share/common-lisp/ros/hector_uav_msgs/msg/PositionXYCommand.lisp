...
(cl:defmethod cl:initialize-instance :after ((m <PositionXYCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionXYCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<PositionXYCommand> is deprecated: use hector_uav_msgs-msg:PositionXYCommand instead.")))
