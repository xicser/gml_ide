...
(cl:defmethod cl:initialize-instance :after ((m <ServoCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<ServoCommand> is deprecated: use hector_uav_msgs-msg:ServoCommand instead.")))
...
(cl:defmethod value-val ((m <ServoCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:value-val is deprecated.  Use hector_uav_msgs-msg:value instead.")
  (value m))
