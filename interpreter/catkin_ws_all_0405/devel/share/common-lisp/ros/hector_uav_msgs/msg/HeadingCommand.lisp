...
(cl:defmethod cl:initialize-instance :after ((m <HeadingCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeadingCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<HeadingCommand> is deprecated: use hector_uav_msgs-msg:HeadingCommand instead.")))
...
(cl:defmethod heading-val ((m <HeadingCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:heading-val is deprecated.  Use hector_uav_msgs-msg:heading instead.")
  (heading m))
