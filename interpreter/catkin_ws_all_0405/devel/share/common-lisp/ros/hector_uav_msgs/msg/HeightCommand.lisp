...
(cl:defmethod cl:initialize-instance :after ((m <HeightCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeightCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<HeightCommand> is deprecated: use hector_uav_msgs-msg:HeightCommand instead.")))
...
(cl:defmethod height-val ((m <HeightCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:height-val is deprecated.  Use hector_uav_msgs-msg:height instead.")
  (height m))
