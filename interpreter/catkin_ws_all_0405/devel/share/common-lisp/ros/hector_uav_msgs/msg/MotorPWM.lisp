...
(cl:defmethod cl:initialize-instance :after ((m <MotorPWM>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorPWM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<MotorPWM> is deprecated: use hector_uav_msgs-msg:MotorPWM instead.")))
...
(cl:defmethod pwm-val ((m <MotorPWM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:pwm-val is deprecated.  Use hector_uav_msgs-msg:pwm instead.")
  (pwm m))
