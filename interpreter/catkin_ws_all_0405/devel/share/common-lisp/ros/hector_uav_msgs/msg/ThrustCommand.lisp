...
(cl:defmethod cl:initialize-instance :after ((m <ThrustCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ThrustCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<ThrustCommand> is deprecated: use hector_uav_msgs-msg:ThrustCommand instead.")))
...
(cl:defmethod thrust-val ((m <ThrustCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:thrust-val is deprecated.  Use hector_uav_msgs-msg:thrust instead.")
  (thrust m))
