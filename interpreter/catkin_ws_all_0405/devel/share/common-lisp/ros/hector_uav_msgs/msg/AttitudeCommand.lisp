...
(cl:defmethod cl:initialize-instance :after ((m <AttitudeCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AttitudeCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<AttitudeCommand> is deprecated: use hector_uav_msgs-msg:AttitudeCommand instead.")))
...
(cl:defmethod roll-val ((m <AttitudeCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:roll-val is deprecated.  Use hector_uav_msgs-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <AttitudeCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:pitch-val is deprecated.  Use hector_uav_msgs-msg:pitch instead.")
  (pitch m))
