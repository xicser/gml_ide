...
(cl:defmethod cl:initialize-instance :after ((m <VelocityZCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelocityZCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_uav_msgs-msg:<VelocityZCommand> is deprecated: use hector_uav_msgs-msg:VelocityZCommand instead.")))
...
(cl:defmethod z-val ((m <VelocityZCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_uav_msgs-msg:z-val is deprecated.  Use hector_uav_msgs-msg:z instead.")
  (z m))
