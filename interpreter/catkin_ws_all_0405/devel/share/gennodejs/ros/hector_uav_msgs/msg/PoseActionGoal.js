...
class PoseActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PoseGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PoseGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PoseActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PoseGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PoseGoal()
    }
