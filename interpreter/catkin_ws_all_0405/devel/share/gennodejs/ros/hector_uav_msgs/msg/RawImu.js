...
class RawImu {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.int16(obj.angular_velocity, buffer, bufferOffset, 3);
    ...
    bufferOffset = _arraySerializer.int16(obj.linear_acceleration, buffer, bufferOffset, 3);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.angular_velocity = _arrayDeserializer.int16(buffer, bufferOffset, 3)
    // Deserialize message field [linear_acceleration]
    data.linear_acceleration = _arrayDeserializer.int16(buffer, bufferOffset, 3)
    return data;
  }
