...
class LandingActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LandingFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LandingFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LandingActionFeedback(null);
    ...
    data.feedback = LandingFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LandingFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LandingActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LandingFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LandingFeedback()
    }
...
module.exports = LandingActionFeedback;
