...
class TakeoffActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TakeoffFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TakeoffFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TakeoffActionFeedback(null);
    ...
    data.feedback = TakeoffFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TakeoffFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TakeoffActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TakeoffFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TakeoffFeedback()
    }
...
module.exports = TakeoffActionFeedback;
