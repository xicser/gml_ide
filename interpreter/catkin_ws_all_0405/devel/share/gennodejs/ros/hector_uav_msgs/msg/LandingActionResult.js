...
class LandingActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LandingResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LandingActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = LandingResult.Resolve(msg.result)
    }
    else {
      resolved.result = new LandingResult()
    }
...
module.exports = LandingActionResult;
