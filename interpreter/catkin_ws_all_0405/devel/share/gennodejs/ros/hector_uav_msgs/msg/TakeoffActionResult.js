...
class TakeoffActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TakeoffResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TakeoffActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = TakeoffResult.Resolve(msg.result)
    }
    else {
      resolved.result = new TakeoffResult()
    }
...
module.exports = TakeoffActionResult;
