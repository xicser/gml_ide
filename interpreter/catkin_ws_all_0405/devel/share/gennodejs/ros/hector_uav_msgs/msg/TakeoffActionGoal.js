...
class TakeoffActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TakeoffGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TakeoffActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TakeoffGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TakeoffGoal()
    }
...
module.exports = TakeoffActionGoal;
