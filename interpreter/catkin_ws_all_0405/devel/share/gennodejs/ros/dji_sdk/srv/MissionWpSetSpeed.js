...
class MissionWpSetSpeedRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionWpSetSpeedRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionWpSetSpeedRequest(null);
...
class MissionWpSetSpeedResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionWpSetSpeedResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionWpSetSpeedResponse(null);
...
module.exports = {
  ...
  md5sum() { return 'b087da1f6984d35b6029aa78841b05a6'; },
  datatype() { return 'dji_sdk/MissionWpSetSpeed'; }
};
