...
"""autogenerated by genpy from hector_uav_msgs/LandingAction.msg. Do not edit."""
import codecs
import sys
...
class LandingAction(genpy.Message):
  _md5sum = "7144d609899bed86e50e32f753240295"
  _type = "hector_uav_msgs/LandingAction"
...
"""
  ...
  _slot_types = ['hector_uav_msgs/LandingActionGoal','hector_uav_msgs/LandingActionResult','hector_uav_msgs/LandingActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LandingAction, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.landing_zone.header.seq, _x.action_goal.goal.landing_zone.header.stamp.secs, _x.action_goal.goal.landing_zone.header.stamp.nsecs))
      _x = self.action_goal.goal.landing_zone.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.action_goal.goal.landing_zone.pose.position.x, _x.action_goal.goal.landing_zone.pose.position.y, _x.action_goal.goal.landing_zone.pose.position.z, _x.action_goal.goal.landing_zone.pose.orientation.x, _x.action_goal.goal.landing_zone.pose.orientation.y, _x.action_goal.goal.landing_zone.pose.orientation.z, _x.action_goal.goal.landing_zone.pose.orientation.w, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.action_feedback.feedback.current_pose.pose.position.x, _x.action_feedback.feedback.current_pose.pose.position.y, _x.action_feedback.feedback.current_pose.pose.position.z, _x.action_feedback.feedback.current_pose.pose.orientation.x, _x.action_feedback.feedback.current_pose.pose.orientation.y, _x.action_feedback.feedback.current_pose.pose.orientation.z, _x.action_feedback.feedback.current_pose.pose.orientation.w))
