...
"""autogenerated by genpy from hector_uav_msgs/RawRC.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sH'%length
      buff.write(struct.Struct(pattern).pack(*self.channel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.channel = s.unpack(str[start:end])
      return self
