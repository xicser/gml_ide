...
"""autogenerated by genpy from hector_uav_msgs/TakeoffActionGoal.msg. Do not edit."""
import codecs
import sys
...
class TakeoffActionGoal(genpy.Message):
  _md5sum = "4b30be6cd12b9e72826df56b481f40e0"
  _type = "hector_uav_msgs/TakeoffActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','hector_uav_msgs/TakeoffGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TakeoffActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = hector_uav_msgs.msg.TakeoffGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = hector_uav_msgs.msg.TakeoffGoal()
