...
"""autogenerated by genpy from hector_uav_msgs/LandingActionResult.msg. Do not edit."""
import codecs
import sys
...
class LandingActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hector_uav_msgs/LandingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hector_uav_msgs/LandingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LandingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hector_uav_msgs.msg.LandingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hector_uav_msgs.msg.LandingResult()
