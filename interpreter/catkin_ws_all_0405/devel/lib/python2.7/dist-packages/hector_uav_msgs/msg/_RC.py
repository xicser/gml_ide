...
"""autogenerated by genpy from hector_uav_msgs/RC.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.axis))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.swit))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.axis = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.swit = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
