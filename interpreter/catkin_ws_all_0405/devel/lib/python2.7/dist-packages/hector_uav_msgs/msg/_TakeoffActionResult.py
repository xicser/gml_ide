...
"""autogenerated by genpy from hector_uav_msgs/TakeoffActionResult.msg. Do not edit."""
import codecs
import sys
...
class TakeoffActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hector_uav_msgs/TakeoffActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hector_uav_msgs/TakeoffResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TakeoffActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hector_uav_msgs.msg.TakeoffResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hector_uav_msgs.msg.TakeoffResult()
