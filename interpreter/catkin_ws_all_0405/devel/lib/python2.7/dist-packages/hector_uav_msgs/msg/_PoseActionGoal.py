...
"""autogenerated by genpy from hector_uav_msgs/PoseActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PoseActionGoal(genpy.Message):
  _md5sum = "660d6895a1b9a16dce51fbdd9a64a56b"
  _type = "hector_uav_msgs/PoseActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','hector_uav_msgs/PoseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = hector_uav_msgs.msg.PoseGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = hector_uav_msgs.msg.PoseGoal()
