...
"""autogenerated by genpy from hector_uav_msgs/EnableMotorsRequest.msg. Do not edit."""
import codecs
import sys
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from hector_uav_msgs/EnableMotorsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class EnableMotors(object):
  _type          = 'hector_uav_msgs/EnableMotors'
  _md5sum = '6a0b406242562fc416b2c9c8a3efb051'
  _request_class  = EnableMotorsRequest
  _response_class = EnableMotorsResponse
