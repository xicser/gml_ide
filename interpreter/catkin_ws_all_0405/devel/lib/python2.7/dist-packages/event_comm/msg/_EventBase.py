...
"""autogenerated by genpy from event_comm/EventBase.msg. Do not edit."""
import codecs
import sys
...
class EventBase(genpy.Message):
  _md5sum = "d88ecb03d6ed3e38611b950e30397c7a"
  _type = "event_comm/EventBase"
...
float64 z
"""
  __slots__ = ['header','eventID','source','begintime','endtime','startPoint','endPoint']
  _slot_types = ['std_msgs/Header','string','string','time','time','geometry_msgs/Point','geometry_msgs/Point']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,eventID,source,begintime,endtime,startPoint,endPoint
